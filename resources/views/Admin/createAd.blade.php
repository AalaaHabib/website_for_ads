...
<div class="container py-5 mt-5">
    ...
    <form class="mt-5"  method="post" action="{{route('storeAd')}}" enctype="multipart/form-data">
        @csrf
    ...
    <div class="form-group">
        ...
        <textarea rows="5" name="desc" class="form-control" id="exampleInputPassword1"></textarea> 
    </div>
  <div class="row">
      <div class="col-6">
        <div class="form-group ">
